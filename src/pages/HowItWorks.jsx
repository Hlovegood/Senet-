...
import { ChefHat, Smartphone, Glasses, PlayCircle, ArrowRight, CheckCircle, Star } from 'lucide-react';
...
const steps = [
  {
    number: 1,
    title: "Pick a Recipe",
    description: "Browse through thousands of authentic Egyptian recipes. Filter by cuisine, dietary preferences, or difficulty level. Each recipe includes detailed ingredient lists and user reviews.",
    icon: ChefHat,
    color: "orange-grad",
  ...
  },
  {
    ...
    description: "Insert your smartphone into a compatible VR/AR headset. Senet works with most mobile headsets including Google Cardboard and Samsung Gear VR.",
    icon: Glasses,
    color: "green-grad",
    image: "https://images.unsplash.com/photo-1713869782574-aa4cc08f4952?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    features: ["Auto-calibrates screen", "Comfortable for long sessions", "Universal fit"],
    tip: "Make sure your phone is fully charged before starting!"
  },
  {
    number: 3,
    title: "Follow AR Holograms",
    description: "Watch as holographic cooking instructions appear in your kitchen! The AR overlays show you exactly what to do, highlighting ingredients in real-time.",
    icon: PlayCircle,
    color: "orange-grad",
  ...
  return (
    <>
      ...
      <div className="how-it-works-wrapper">
        ...
        <motion.img 
          src={imgSombrero} className="deco-icon-how" style={{ top: '20%', right: '5%' }}
          animate={{ rotate: [0, 10, 0] }} transition={{ repeat: Infinity, duration: 5 }}
        />
        <motion.img 
          src={imgChilli} className="deco-icon-how" style={{ bottom: '15%', left: '5%' }}
          animate={{ y: [0, -20, 0] }} transition={{ repeat: Infinity, duration: 3 }}
        />

        <div className="how-container">
          {/* Header */}
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <h1 className="Brigten" style={{ fontSize: 'clamp(2.5rem, 8vw, 4.5rem)' }}>How It Works</h1>
            <p style={{ color: '#ffd8bb', fontSize: '1.2rem', marginTop: '10px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '20px', marginBottom: '50px' }}>
            {steps.map((step, idx) => (
              <React.Fragment key={step.number}>
                ...
                {idx < steps.length - 1 && (
                  <div style={{ width: '50px', h: '2px', background: activeStep > step.number ? '#00804D' : 'rgba(255,255,255,0.2)', height: '2px' }} />
                )}
              </React.Fragment>
            ))}
          </div>
            ...
            >
              ...
              <div style={{ padding: '50px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '20px' }}>
                  ...
                  <h2 className="Brigten" style={{ fontSize: '2.5rem' }}>{currentStep.title}</h2>
                </div>
                <p style={{ fontSize: '1.1rem', lineHeight: '1.6', marginBottom: '30px' }}>{currentStep.description}</p>
                ...
                <div style={{ borderLeft: '4px solid white', paddingLeft: '15px', fontStyle: 'italic', opacity: 0.9 }}>
                  💡 {currentStep.tip}
                </div>
              </div>
    ...
    Step {activeStep} of 3
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '30px' }}>
            ...
            <button 
              ...
              onClick={() => activeStep < 3 ? setActiveStep(prev => prev + 1) : alert("Redirecting to Recipes...")}
            >
          ...
          <section className="careers-cta orange-grad" style={{ textAlign: 'center', padding: '80px 20px', borderRadius: '40px', marginTop: '100px' }}>
             <h2 className="Brigten" style={{ fontSize: '3rem' }}>Ready to transform your kitchen?</h2>
             <p style={{ margin: '20px 0', fontSize: '1.2rem' }}>Join the future of Egyptian cooking today.</p>
